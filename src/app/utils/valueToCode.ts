...
export const valueToCode = {
    ...
    applicationType: (value: string) => APPLICATION_TYPES.find(type => type.value === value)?.code,
    ...
    submissionType: (value: string) => SUBMISSION_TYPES.find(type => type.value === value)?.code,
